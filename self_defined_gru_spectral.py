...
class GRUCell(nn.Module):
  def __init__(self, input_size, hidden_size, bias=False, num_chunks=3):
    ...
    self.weight_ih = nn.Parameter(torch.Tensor(num_chunks * hidden_size, input_size))
    ##self.weight_hh = nn.Parameter(torch.Tensor(num_chunks * hidden_size, hidden_size))
#     self.linear_hh = spectral_norm(nn.Linear(input_size, num_chunks * hidden_size))
...
#     # hidden = 0.5*i_n+0.25*h_n+0.5*hidden\
#     #     +0.25*(i_i+h_i)*(hidden-i_n)\
#     #     +1/8*(i_r+h_r-i_i-h_i)*h_n \
#     #     -1/16*(h_r*h_n*i_i+h_i*h_n*i_r+i_r*i_n*h_n+h_r*h_i*h_n)
...
#     #     +0.25*(i_i+h_i)*(hidden-i_n)\
#     #     +1/8*(i_r+h_r-i_i-h_i)*h_n \
#     #     -1/16*(h_r*h_n*i_i+h_i*h_n*i_r+i_r*i_n*h_n)

# # ##*****************************first order************************************************#
# #     hidden = 0.5*i_n-0.25*i_i*i_n+0.25*h_n+0.5*hidden\
# #         +0.25*i_i*hidden-0.25*h_i*i_n\
# #         +1/8*(i_r-i_i)*h_n \
# #         -1/16*i_r*i_n*h_n
...
# ##******************************Self proposed**********************************************#
#     # hidden = (0.5*i_n-0.25*i_n*i_i+0.5*hidden+0.25*h_n+0.25*i_i*h_i+0.25*i_n*h_n+0.25*i_r*h_r)/2
...
#     # inputgate = torch.sigmoid(i_i + h_i)#(i_i + h_i)*0.25+0.5-(i_i + h_i)**3*(0.6/48)
#     # temp = i_n + resetgate * h_n
#     # newgate = self.hardtanh(temp-temp**3/3)
#     # hidden = newgate + inputgate * (hidden - newgate)
    
# # #     hidden = 0.5*i_n-0.25*i_n*i_i+0.5*hidden+0.25*h_n+0.25*i_i*hidden-0.25*h_i*i_n+0.125*(i_r-i_i)*h_n-1/16*i_r*i_i*h_n
    
#     # hidden = 0.5*i_n-0.25*i_n*i_i+0.5*hidden+0.25*h_n+0.25*i_i*h_i+0.25*i_n*h_n+0.25*i_r*h_r
   

    
# #     #hidden = 0.5*i_n+0.25*h_n+0.5*hidden-0.25*i_n*i_i+0.25*(i_r-i_i)*h_n\
# #     #      #+0.25*h_i*hidden-1/16*(h_r*h_n*i_i+h_i*h_n*i_r+i_r*i_n*h_n+h_r*h_i*h_n)
# #     # # #hidden = 0.5*i_n+0.25*h_n+0.5*hidden-0.25*i_n*i_i#+0.25*(i_i*hidden+h_i*i_n+i_r*h_n)
